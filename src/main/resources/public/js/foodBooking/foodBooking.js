layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        url : ctx + '/foodBooking/list', // 访问数据的地址
        cellMinWidth : 95,
        page : true, // 开启分页
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'foodName', title: '餐品名',  align:'center'},
            {field: 'foodTypeName', title: '餐品类型', align:'center'},
            {field: 'foodPrice', title: '餐品价格', align:'center'},
            {field: 'foodCount', title: '份数', align:'center'},
            {field: 'allPrice', title: '总价格', align:'center'},
            {field: 'orderer', title: '点餐顾客', align:'center'},
            {field: 'bookingTime', title: '点餐时间', align:'center'},
    ...
    $(".search_btn").click(function(){
        ...
        table.reload("customerList",{
            where: { //设定异步数据接口的额外参数，任意设
                ...
                orderer:$("input[name=orderer]").val(),
    ...
    function  addOrUpdateSaleChanceDialog(id){
        var title="<h3>餐饮消费-添加</h3>";
        var url=ctx+"/foodBooking/addOrUpdateDialog";
