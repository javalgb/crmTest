layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'roomTypeId', title: '房间类型编号',align:"center"},
            {field: 'roomType', title: '房间类型',  align:'center'},
            {field: 'roomRemark', title: '房间介绍', align:'center'},
            {field: 'createTime', title: '上次使用时间', align:'center'},
    ...
    $(".search_btn").click(function(){
        ...
        table.reload("roomTypeList",{
            where: { //设定异步数据接口的额外参数，任意设
                ...
                roomRemark:$("input[name=roomIntro]").val()
            }
            ,page: {
                curr: 1 //重新从第 1 页开始
            }
    ...
    function  addOrUpdateSaleChanceDialog(id){
        ...
        var url=ctx+"/roomType/addOrUpdateDialog";
