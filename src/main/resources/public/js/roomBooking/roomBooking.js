layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        url : ctx + '/roomBooking/list', // 访问数据的地址
        cellMinWidth : 95,
        page : true, // 开启分页
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'customerName', title: '顾客名',  align:'center'},
            {field: 'customerPhone', title: '手机号', align:'center'},
            {field: 'bookingDay', title: '天数', align:'center'},
            {field: 'price', title: '价格', align:'center'},
            {field: 'bookTime', title: '开始时间', align:'center'},
    ...
    function  addOrUpdateSaleChanceDialog(id){
        var title="<h3>入住消费-添加</h3>";
        var url=ctx+"/roomBooking/addOrUpdateDialog";
