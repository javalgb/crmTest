...
<#--        <input type="hidden" name="man" value="${(saleChance.assignMan)!}">-->
        <label class="layui-form-label">菜品类型名</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input"  name="foodTypeName"
                   id="foodTypeName" value="${(foodType.foodTypeName)!}" placeholder="请输入菜品类型名">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="foodIntro"
                   lay-verify="required"  value="${(foodType.foodIntro)!}" placeholder="请输入菜品介绍">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
